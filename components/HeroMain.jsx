...
const App = () => {
    ...
    const handleMouseMoveOnCard = (e) => {
        ...
        const rotateX = mouseY * -20; // Invert for a natural feel
    ...
    // Handler to reset the card's position when the mouse leaves
    ...
    return (
        <div className="bg-[#0f172a] text-white font-sans">
             <div
                ...
                style={{
                    background: `radial-gradient(1000px circle at ${x}px ${y}px, rgba(167, 139, 250, 0.1), transparent 50%)`
                }}
            />
            <section className="relative min-h-screen flex items-center justify-center pt-20 pb-20 px-6 z-10 overflow-hidden">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        {/* Floating Orbs */}
                        <div style={floatingOrb1Style} className="absolute -top-8 -left-8 w-20 h-20 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-full blur-2xl opacity-60 transition-transform duration-300 ease-out" />
                        <div style={floatingOrb2Style} className="absolute -bottom-8 -right-8 w-24 h-24 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full blur-2xl opacity-60 transition-transform duration-300 ease-out" />
                    </div>
                </div>
            </section>
        </div>
